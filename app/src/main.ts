...
import { splitOversizeParts } from './splitParts';
...
const state: {
   ...
   *  last estimate, keyed by segment part id. The unplaced STEP export needs
   *  this because segment ids don't resolve to a source body. */
  splitSegmentGeo: Map<string, { outer: [number, number][]; holes: [number, number][][]; thickness: number }>;
